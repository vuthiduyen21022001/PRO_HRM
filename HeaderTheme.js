    ...
    <div>
      <StyleHeader>
        <div className="Navbar">
          ...
          <div className="Navbar_Course"></div>
        ...
        }} className="btnLogout">Đăng Xuất</button>
              ...
              <ul className="User_menu_portal">
                <div className="UserMenu_user">
                  ...
                  <div className="UserMenu_info">
                    <div className="UserMenu_name">{user?.username} </div>
                    <div className="UserMenu_username">{user?.email} </div>
                  </div>
                </div>
                <hr />
